...
def create_video_from_tiff(folder_path, output_folder, fps=30):
    # Get a list of all TIFF files in the folder
    tiff_files = [file for file in os.listdir(
        folder_path) if file.endswith(".tiff")]
    if not tiff_files:
...
if __name__ == "__main__":
    folder_path = "/Users/abasaltbahrami/Downloads/Film"
    output_folder = "/Users/abasaltbahrami/Downloads/FilmOutput"
    create_video_from_tiff(folder_path, output_folder, fps=30)
